    ...
    try {
        ...
        if (error) {
            ...
            return NextResponse.redirect(
                `${process.env.NEXTAUTH_URL || "http://localhost:3000"}/dashboard?error=github_oauth_error&details=${error}`,
            )
        }
        ...
        if (!tokenResponse.ok) {
            ...
            return NextResponse.redirect(
                `${process.env.NEXTAUTH_URL || "http://localhost:3000"}/dashboard?error=token_exchange_failed`,
            )
        }
        ...
        if (tokenData.error) {
            ...
            return NextResponse.redirect(
                `${process.env.NEXTAUTH_URL || "http://localhost:3000"}/dashboard?error=github_token_error&details=${tokenData.error}`,
            )
        }
        ...
        if (!tokenData.access_token) {
            ...
            return NextResponse.redirect(
                `${process.env.NEXTAUTH_URL || "http://localhost:3000"}/dashboard?error=no_access_token`,
            )
        }
        ...
        if (!userResponse.ok) {
            ...
            return NextResponse.redirect(
                `${process.env.NEXTAUTH_URL || "http://localhost:3000"}/dashboard?error=github_api_failed`,
            )
        }
        ...
        if (!userData.login) {
            ...
            return NextResponse.redirect(`${process.env.NEXTAUTH_URL || "http://localhost:3000"}/dashboard?error=no_username`)
        }
